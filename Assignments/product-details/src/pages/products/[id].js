  ...
  return (
    <>
      <Head>
        ...
        <meta name="discription" content={product.shortDisc} />
        <meta property="og:title" content={`${product.name} | My Store`} />
        <meta property="og:description" content={product.shortDisc} />
        <meta property="og:image" content={product.image} />
        <meta
          property="og:url"
          content={`https://yourdomain.com/products/${product.id}`}
        />
      </Head>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">
              {product.longDisc || product.shortDisc}
            </p>
